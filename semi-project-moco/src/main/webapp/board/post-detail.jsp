	...
	<table class="table">
		...
		<tr>
			<td colspan="4">
				...
				<pre>
					<textarea id="editor" name="editor" rows="10">${requestScope.pvo.post_code}</textarea>
				</pre>
				<script>
		...
		<tr>
			<td colspan="4">
				<%-- pre : db 에 저장된 글형식 그대로 표현  --%>
				<pre>
					<font size="4"> ${requestScope.pvo.post_content} </font>
				</pre>
			</td>
		</tr>
			...
			<tr>
				...
				<td colspan="4" class="text-center">
					...
					<form action="EditPostPageController.do" id="updateForm" method="post">
						<input type="hidden" name="postNo" id="no" value="${requestScope.pvo.post_no}"> <input type="hidden" name="languageCode" id="no" value="${requestScope.pvo.lvo.language_code}">
					</form>
